...
void exit_with_help()
{
  ...
  "\n Usage\n"
  "     Train: svmlinear [options] training_examples training_labels\n"
  "      Test: svmlinear -f weights_file test_examples\n"
  "  Evaluate: svmlinear -f weights_file test_examples test_labels\n"
  "\n Options:\n"
